...
Note that this creates a pickle file that stores old
energies, temperatures, and coordinates.  The pickle is
updated every time we run the script so it's resistant to
Keeneland's autodeletion scripts, ha ha."""
